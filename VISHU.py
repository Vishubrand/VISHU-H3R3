...
\ \ / / |_ _|/ __| | || || | | |  | _ )| _ \  (_)_\(_)| \| | |   \  
 \ V /   | | \__ \ | __ || |_| |  | _ \|   /   / _ \  | .` | | |) | 
  \_/   |___||___/ |_||_| \___/   |___/|_|_\  /_/ \_\ |_|\_| |___/  
    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.YELLOW + f"[+] VISHU BRAND {message_index + 1} S3NT TO C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} at {current_time}")
...
def main():
    ...
    print(Fore.MAGENTA + " WELCOME TO VISHU TOOL ")
    print(Fore.CYAN + "------------------------------------")
